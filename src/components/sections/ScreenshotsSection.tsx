...
export function ScreenshotsSection() {
  ...
  const screenshots = [
    {
      src: '/images/screenshots/launch.PNG',
      alt: 'Launch Screen - Welcome to Ezy Photo Clean',
    },
    {
      src: '/images/screenshots/analyze.PNG',
      alt: 'Analyze Photos - AI-powered scanning',
    },
    ...
    {
      src: '/images/screenshots/insight.PNG',
      alt: 'Storage Insights & Analytics',
    },
    {
      src: '/images/screenshots/insight 2.PNG',
      alt: 'Detailed Storage Breakdown',
    },
  ...
  return (
    <section className='py-16 lg:py-24 bg-secondary/30 overflow-hidden'>
      <div className='container mx-auto px-4 lg:px-8'>
            ...
            {[...screenshots, ...screenshots, ...screenshots].map(
              (screenshot, index) => (
                <motion.div
                  ...
                  transition={{
                    duration: 0.5,
                    delay: (index % screenshots.length) * 0.05,
                  }}
        ...
        >
          {[
            ...
            { label: 'Multiple Modes', value: '7 Detection Types' },
